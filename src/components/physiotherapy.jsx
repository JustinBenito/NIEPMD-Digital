      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          if (data.physiotherapy) {
            setPatientComplaint(data.physiotherapy.patientComplaint || '');
            setEarlierTherapies(data.physiotherapy.earlierTherapies || '');
            setAssessmentPoints(data.physiotherapy.assessmentPoints || '');
            setTestsAdministered(data.physiotherapy.testsAdministered || '');
            setProvisionalDiagnosis(data.physiotherapy.provisionalDiagnosis || '');
            setManagementPlan(data.physiotherapy.managementPlan || '');
            setReferrals(data.physiotherapy.referrals || '');
          }
        }
      } catch (error) {
