                ...
                if (docSnap.exists()) {
                    ...
                    if (data.history) {
                        ...
                        if (data.history.antenatal) {
                            ...
                            document.getElementById('first_name').value = antenatal.fatherBloodGroup || '';
                            document.getElementById('last_name').value = antenatal.motherBloodGroup || '';
                            document.getElementById('email').value = antenatal.complications || '';
                        }
                        ...
                        if (data.history.intranatal) {
                            ...
                            if (intranatal.birthCry) {
                                document.querySelector(`input[name="list-radio7"][value="${intranatal.birthCry}"]`).checked = true;
                            }
                            document.querySelector('input[name="birthWeight"]').value = intranatal.birthWeight || '';
                            document.querySelector('input[name="babyActivity"]').value = intranatal.babyActivity || '';
                            document.querySelector('textarea[name="congenitalAnomalies"]').value = intranatal.congenitalAnomalies || '';
                        }
                        ...
                        if (data.history.postnatal) {
                            ...
                            if (postnatal.condition) {
                                document.querySelector(`input[name="list-radio8"][value="${postnatal.condition}"]`).checked = true;
                            }
                            ...
                            document.querySelector('textarea[name="previousConsultation"]').value = postnatal.previousConsultation || '';
                        }
                    }
                }
            } catch (error) {
        ...
        try {
            ...
            const formData = {
                antenatal: {
                    ...
                    fatherBloodGroup: document.getElementById('first_name').value,
                    motherBloodGroup: document.getElementById('last_name').value,
                    complications: document.getElementById('email').value
                },
                intranatal: {
                    ...
                    birthWeight: document.querySelector('input[name="birthWeight"]').value,
                    babyActivity: document.querySelector('input[name="babyActivity"]').value,
                    congenitalAnomalies: document.querySelector('textarea[name="congenitalAnomalies"]').value
                },
                postnatal: {
                    ...
                    immunization: {
                        bcg: document.querySelector('input[value="BCG"]')?.checked || false,
                        polio: document.querySelector('input[value="Polio"]')?.checked || false,
                        dpt: document.querySelector('input[value="DPT"]')?.checked || false,
                        measles: document.querySelector('input[value="Measles"]')?.checked || false,
                        pentavalent: document.querySelector('input[value="Pentavalent"]')?.checked || false,
                        mmr: document.querySelector('input[value="MMR"]')?.checked || false
                    },
                    previousConsultation: document.querySelector('textarea[name="previousConsultation"]')?.value || ''
                }
            };
...
<ul className="items-center mt-4 w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex   dark:border-gray-600  ">
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-license" type="radio" value="hypertension" name="list-radio2" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300   dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-license" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Hypertension</label>
        </div>
    </li>
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-id" type="radio" value="irradiation" name="list-radio2" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300    dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-id" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Irradiation</label>
        </div>
    </li>
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-millitary" type="radio" value="medications" name="list-radio2" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300     dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-millitary" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Medications</label>
        </div>
    </li>
...
<ul className="items-center w-full  mt-4 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex   dark:border-gray-600  ">
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-license" type="radio" value="diabetes" name="list-radio3" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300   dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-license" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Diabetes</label>
        </div>
    </li>
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-id" type="radio" value="caeserian" name="list-radio6" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300    dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-id" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Trauma</label>
        </div>
    </li>
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-millitary" type="radio" value="forceps" name="list-radio6" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300     dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-millitary" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Abortion</label>
        </div>
    </li>
    ...
    <div className="grid gap-6 mb-6 md:grid-cols-2 mt-8">
        <div>
            <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-gray-900  ">Blood Group of Father</label>
            <input type="text" id="first_name" name="birthWeight" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5   dark:border-gray-600 dark:placeholder-gray-400   dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="O +ve" required />
        </div>
        <div>
            <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-gray-900  ">Blood Group of Mother</label>
            <input type="text" id="last_name" name="babyActivity" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5   dark:border-gray-600 dark:placeholder-gray-400   dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="A +ve" required />
        </div>
...
<ul className="items-center mt-2 w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex   dark:border-gray-600  ">
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-license" type="radio" value="normal" name="list-radio4" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300   dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-license" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Normal</label>
        </div>
    </li>
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-id" type="radio" value="prolonged" name="list-radio4" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300    dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-id" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Prolonged</label>
        </div>
    </li>
...
<ul className="items-center mt-2 w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex   dark:border-gray-600  ">
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-license" type="radio" value="hospital" name="list-radio5" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300   dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-license" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Hospital</label>
        </div>
    </li>
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-id" type="radio" value="home" name="list-radio5" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300    dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-id" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Home</label>
        </div>
    </li>
...
<ul className="items-center w-full  mt-4 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex   dark:border-gray-600  ">
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-license" type="radio" value="normal" name="list-radio6" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300   dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-license" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Normal</label>
        </div>
    </li>
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-id" type="radio" value="caeserian" name="list-radio6" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300    dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-id" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Caeserian</label>
        </div>
    </li>
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-millitary" type="radio" value="forceps" name="list-radio6" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300     dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-millitary" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Forceps</label>
        </div>
    </li>
    ...
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-millitary" type="radio" value="forceps" name="list-radio6" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300     dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-millitary" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Precipitate</label>
        </div>
    </li>
    ...
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-millitary" type="radio" value="forceps" name="list-radio6" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300     dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-millitary" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Prolonged</label>
        </div>
    </li>
    ...
    <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
        <div className="flex items-center pl-3">
            <input id="horizontal-list-radio-millitary" type="radio" value="forceps" name="list-radio6" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300     dark:border-gray-500"/>
            <label htmlFor="horizontal-list-radio-millitary" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Induced</label>
        </div>
    </li>
...
<div>
    ...
    {/* <div className="grid gap-6 mb-6 md:grid-cols-2 mt-8">
        <div>
            <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-gray-900  ">Birth Weight</label>
            <input type="text" id="first_name" name="birthWeight" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5   dark:border-gray-600 dark:placeholder-gray-400   dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="23" required />
        </div>
        <div>
            <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-gray-900  ">Activity of the Baby</label>
            <input type="text" id="last_name" name="babyActivity" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5   dark:border-gray-600 dark:placeholder-gray-400   dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Good" required />
        </div>
...
<div className="mb-6">
        <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900  ">Previous Consultation or treatment</label>
        <textarea type="text" id="email" name="previousConsultation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5   dark:border-gray-600 dark:placeholder-gray-400   dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='Any Undertaken?' required />
        </div> 
