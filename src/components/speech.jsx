    ...
    const fetchData = async () => {
      try {
        ...
        if (docSnap.exists()) {
          ...
          if (data.speech) {
            setPatientComplaint(data.speech.patientComplaint || '');
            setEarlierTherapies(data.speech.earlierTherapies || '');
            setAssessmentPoints(data.speech.assessmentPoints || '');
            setTestsAdministered(data.speech.testsAdministered || '');
            setProvisionalDiagnosis(data.speech.provisionalDiagnosis || '');
            setManagementPlan(data.speech.managementPlan || '');
            setReferrals(data.speech.referrals || '');
          }
        }
      } catch (error) {
