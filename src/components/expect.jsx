...
<div className="mb-6">
        <label htmlFor="expectations" className="block mb-2 text-5xl font-bold text-gray-900  ">Expectations</label>
        <textarea type="text" id="expectations" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5   dark:border-gray-600 dark:placeholder-gray-400   dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='Any Expectations?' required />
        </div> 
