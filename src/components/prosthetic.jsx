    ...
    const fetchData = async () => {
      try {
        ...
        if (docSnap.exists()) {
          ...
          if (data.prosthetic) {
            setPatientComplaint(data.prosthetic.patientComplaint || '');
            setEarlierTherapies(data.prosthetic.earlierTherapies || '');
            setAssessmentPoints(data.prosthetic.assessmentPoints || '');
            setTestsAdministered(data.prosthetic.testsAdministered || '');
            setProvisionalDiagnosis(data.prosthetic.provisionalDiagnosis || '');
            setManagementPlan(data.prosthetic.managementPlan || '');
            setReferrals(data.prosthetic.referrals || '');
          }
        }
      } catch (error) {
